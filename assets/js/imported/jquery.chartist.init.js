...
//smil-animations Chart
  ...
  series: [
    [130, 150, 200, 250, 120, 104, 160, 200, 300, 300, 200, 400,130, 150, 200, 250, 120, 104, 160, 200, 300, 300, 200, 400,120,150,170,200,300,250,150],
    [50,  100, 70 , 70, 30, 50, 50, 30, 40, 40, 50, 50,50,  100, 70 , 70, 30, 50, 50, 30, 40, 40, 50, 50,60,70,80,90,120,150,100]
  ]
}, {
  low: 0,
  plugins: [
...
var data = {
  labels: ['MORA(M2411) 15%', 'OTTO(01805) 12%', 'INDY(I2011)35%', 'BLANCA(B0904) 30%', 'NENA(N2011) 2%', 'DYNA(D1203) 5%', 'GORO(G2512) 6%'],
  series: [20, 15, 40, 27, 05, 09, 10]
};
